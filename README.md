# Deploy de Desafios - CTFd Plugin

⚠️ **SAIBA O QUE ESTÁ FAZENDO ANTES DE UTILIZAR ESTE PLUGIN** ⚠️

Plugin para CTFd que automatiza o processo de criação e deploy de desafios usando o chall-manager.

## 🚨 IMPORTANTE - Sobre o Registry

**DEPOIS DE FEITO O UPLOAD NO REGISTRY APARECERÁ:**
```
localhost:5000/gthc/sqli
```

**MAS NA HORA QUE FOR REGISTRAR NO CTFD, REGISTRE COMO:**
```
registry:5000/gthc/sqli
```

Isso porque dentro da rede Docker, o registry é acessado pelo nome do serviço `registry`, não por `localhost`.
...
```
https://seu-ctfd.com/admin/deploy-desafios
```
...
- **Nome do Desafio**: Nome único (ex: `sqli`, `pwn_easy`)
